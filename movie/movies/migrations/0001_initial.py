    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(default=8, verbose_name='Возраст')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2019, verbose_name='Дата входа')),
                ('country', models.CharField(max_length=30, verbose_name='Страна')),
                ('world_primiere', models.DateField(default=datetime.date.today, verbose_name='Премьера в мире')),
                ('budget', models.PositiveIntegerField(default=0, help_text='указывать сумму в доллларах', verbose_name='Бюджет')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.actor', verbose_name='режисср')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.movie', verbose_name='фильм')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.reviews', verbose_name='фильм')),
            ],
            options={
                'verbose_name': 'Отзыв',
